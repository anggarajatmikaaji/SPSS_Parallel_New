...
namespace ParallelSPSS
{
    partial class ResultForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.resultTable.Location = new System.Drawing.Point(87, 53);
            ...
            this.resultTable.Size = new System.Drawing.Size(417, 289);
        ...
        void ResultForm_Load(object sender, System.EventArgs e)
        {
            ...
            for(int i=0;i< Form1.results.Count;i++)
            {
                ...
                resultTable.RowStyles.Add(new RowStyle(SizeType.Absolute, 35F));
